        ...
        <div className='about-container'>
            <div className="about-left-box">
                <h1 className="about-left-title">
                    ...
                    <span id='letter_W'>Web</span>
                    <span id='letter_e_one'>-</span>
                    <span id='letter_b'>AI</span>
                    <span id='letter_e_one'>-</span>
                    <span id='letter_e_one'>Software</span>                 
                    &nbsp;
                    <br/>
                    <span id='letter_D_two'>D</span>
                    <span id='letter_e_two'>e</span>
                    <span id='letter_v_two'>v</span>
                    <span id='letter_v_two'>.</span>
            ...
            <div className="about-right-box">
                ...
                <ReactRotatingText items={['', 'Python, Django Specialist', '3D: Person. Enthusiast. Interfacer.', 'UX Designer', 'Problem-Solver', 'Tech Guru']}  style={{ fontSize: '2.25rem'
                }}  />
                <br />
                <br />
